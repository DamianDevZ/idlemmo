  ...
  async () => {
    ...
    return {
      ...
      attributes: {
        ...
        strMeleeDivisor:      v('str_melee_divisor',    G.attributes.strMeleeDivisor),
        dexRangedDivisor:     v('dex_ranged_divisor',   G.attributes.dexRangedDivisor),
        intMagicDivisor:      v('int_magic_divisor',    G.attributes.intMagicDivisor),
