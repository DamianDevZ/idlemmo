  ...
  async () => {
    ...
    return {
      ...
      attributes: {
        ...
        strScalingDivisor:    v('str_scaling_divisor',  G.attributes.strScalingDivisor),
        dexScalingDivisor:    v('dex_scaling_divisor',  G.attributes.dexScalingDivisor),
        intScalingDivisor:    v('int_scaling_divisor',  G.attributes.intScalingDivisor),
